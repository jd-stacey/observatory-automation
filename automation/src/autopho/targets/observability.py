...
class ObservabilityChecker:
    ...
    def __init__(self, observatory_config: Dict[str, Any]):
        if not ASTRO_AVAILABLE:
            raise ObservabilityError("Required astronomy packages not available: please install astropy")
